...
This is the mandatory first-read control plane for **annafejer.art**. It routes agent work; it does not duplicate product documentation or contain product output.
